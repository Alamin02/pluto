        ...
        <div className={styles.contactUsContainer}>
            <Row gutter={[16, 16]}>
                <Col span={12} xs={24} sm={24} md={24} lg={12}>
                    ...
                    <p>If you wish to be considered for employment at Pluto, please do not send a message, here – instead, please complete Pluto's job application  and our Human Resources department will contact you after their review of your submitted information</p>
                </Col>
                <Col span={12} xs={24} sm={24} md={24} lg={12}>
                    <Row gutter={[16, 16]}>
                        ...
                        <Col span={12} xs={24} sm={12} className={classNames(
                            { [styles.lastLabelStyle]: screens.xs }
                        )}>
